...
yellow_spaceship_img = pygame.image.load("C:/Users/daksh/My Drive/Daksh Jetlearn Work/Pro_Game_Developer/images/space_yellow.png")
yellow_spaceship = pygame.transform.rotate(pygame.transform.scale(yellow_spaceship_img, (spaceship_width, spaceship_height)), 90)

red_spaceship_img = pygame.image.load("C:/Users/daksh/My Drive/Daksh Jetlearn Work/Pro_Game_Developer/images/space_red.png")
red_spaceship = pygame.transform.rotate(pygame.transform.scale(red_spaceship_img, (spaceship_width, spaceship_height)), 270)

space = pygame.transform.scale(pygame.image.load("C:/Users/daksh/My Drive/Daksh Jetlearn Work/Pro_Game_Developer/images/bgground.png"), (WIDTH, HEIGHT))
