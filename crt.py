...
score = 0
high_score = 0
pipe_spawn_time = 12000
pipe_gap = 150
scroll_speed = 4
ground_scroll = 0
passed_pipes = []  # to track which pipes were scored
...
while running:
    ...
    if game_active:
        ...
        for pipe in pipe_list:
            if pipe.bottom >= screen_height and pipe not in passed_pipes:
    ...
    screen.blit(ground, (ground_scroll + ground_width, 550))
